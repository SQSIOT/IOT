...
public class MainActivity extends AppCompatActivity {
    ...
    String connectFail = "Connection Error. Please Restart the app.";
...
// For Light 1
        ...
        if (switchButton.isChecked()) {
            ...
            if (mTcpClient.flag==false)
            {
                textView.setText(connectFail);
            }
            textView.setText(switchOff);
        }
        // ATTENTION: This was auto-generated to implement the App Indexing API.
...
// For Main Button
    ...
    switchButton4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
        ...
        if (switchButton.isChecked()&& switchButton2.isChecked() && switchButton3.isChecked() ){
            switchButton4.setChecked(true);
        }
