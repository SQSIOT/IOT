...
try:   
 while True:
    ...
    if i ==0 and j == 0 and k == 0:                     #stop 
    ...
    elif i == 1 and j == 0 and k == 0:                  # moving left
     print "moving Left",i
     ...
     time.sleep(0.1)
    elif i==0 and j == 1 and k == 0:                    # moving right
     ...
     M2N.ChangeDutyCycle(0)
     time.sleep(0.1)
    #elif i==1 and j == 0 and k == 1:                    # moving right
     print "moving Right",j
     M1P.ChangeDutyCycle(0)
     M2P.ChangeDutyCycle(20)
     M1N.ChangeDutyCycle(20)
     M2N.ChangeDutyCycle(0)
     time.sleep(0.1)
    elif i == 1 and j == 1 and k == 0:                  # moving straight
     M1P.ChangeDutyCycle(20)
     M2P.ChangeDutyCycle(20)
     M1N.ChangeDutyCycle(0)
     M2N.ChangeDutyCycle(0)
     print "moving straight",i,j,k
     time.sleep(0.1)
