...
LRed    = np.array([100,0,  0])
HRed    = np.array([255,40, 50])
LGreen  = np.array([0,  100,0])
HGreen  = np.array([30, 155,30])
##LYellow = np.array([150,150,0])
##HYellow = np.array([235,230,30])
...
##                    print "Detected Green"
                ...
                if(color[0] > 100 and color[0] <= 256):
                    LR  = True
                    LG = False
                    Red =  True
                    print" in red radius", i[2]
                    if( Red and (i[2] > 20 )) :
                        SIGN = STOP
                        flag = 1
                        print STOP
                elif(color[1] > 100 and color[1] <= 256):
                    LG = True
                    LR = False
                    Green = True
                    print" in green radius", i[2]
                    if( Green and (i[2] > 20 )):
                        flag = 0
                        SIGN = START
                        print START  
