...
turnspd  = 22 ##18/12 Speed at turning radius
turnspd1 = 16
speed    = 20
...
def Cam():    
        ...
        for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
            ...
            # will be 3D, representing the width, height, and # of channel
            data1 = cam.recv(10)
##            cam.send("OK")
            if(data1 == "GREEN     "):            
        ...
        ##                if center[0] == 0:              ##Commented by mayuresh as bot does not need to be stopped by camera
                    else:
