   ...
   //HIT the Webpage 1.
        ...
        digitalWrite(D3, LOW);
         ...
         data = "Main=ON";
          ...
          WiFiClient client1;
          if (client1.connect("192.168.1.103",8080)) { // REPLACE WITH YOUR SERVER ADDRESS
            Serial.println ("Successful Connection");
            client1.println("POST /iot/MAINON.php HTTP/1.0"); 
            client1.println("Host:192.168.1.103:8080"); // SERVER ADDRESS HERE TOO
...
//----------------------------------------------------
        ...
        WiFiClient client2;
        if (client2.connect("192.168.1.103",8080)) { // REPLACE WITH YOUR SERVER ADDRESS
          Serial.println ("Successful Connection");
          client2.println("POST /iot/MAINOFF.php HTTP/1.0"); 
          client2.println("Host:192.168.1.103:8080"); // SERVER ADDRESS HERE TOO
...
//----------------------------------------------------
        ...
        data3 = "L1=ON";
        WiFiClient client3;
        if (client3.connect("192.168.1.103",8080)) { // REPLACE WITH YOUR SERVER ADDRESS
          Serial.println ("Successful Connection");
          client3.println("POST /iot/LED1ON.php HTTP/1.0"); 
          client3.println("Host:192.168.1.103:8080"); // SERVER ADDRESS HERE TOO
...
//----------------------------------------------------
        ...
        data4 = "L2L3L4=ON";
        WiFiClient client4;
        if (client4.connect("192.168.1.103",8080)) { // REPLACE WITH YOUR SERVER ADDRESS
          Serial.println ("Successful Connection");
          client4.println("POST /iot/L2L3L4ON.php HTTP/1.0"); 
          client4.println("Host:192.168.1.103:8080"); // SERVER ADDRESS HERE TOO
...
//----------------------------------------------------
    //HIT the Webpage 5.
       // data5="";   
        data5 = "L1=OFF";
        WiFiClient client5;
        if (client5.connect("192.168.1.103",8080)) { // REPLACE WITH YOUR SERVER ADDRESS
          Serial.println ("Successful Connection");
          client5.println("POST /iot/LED1OFF.php HTTP/1.0"); 
          client5.println("Host:192.168.1.103:8080"); // SERVER ADDRESS HERE TOO
